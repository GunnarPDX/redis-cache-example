defmodule RedisCacheExample.RedisClient do
  use Supervisor

  @redis_connection_params host: Application.get_env(
      :redis_cache_example, :redis_host),
    password: Application.get_env(:redis_cache_example, :redis_password),
    port: Application.get_env(:redis_cache_example, :redis_port)
